    ...
    <div className='grid gap-4 grid-cols-2 lg:grid-cols-4'>
      <Card>
        <CardHeader className='flex flex-row items-center justify-between pb-2 space-y-0'>
          <CardTitle className='text-sm font-medium'>Sites Associes</CardTitle>
          <Building2 className='w-4 h-4 text-muted-foreground' />
        </CardHeader>
        <CardContent>
          <div className='text-2xl font-bold'>8</div>
          <p className='text-xs text-muted-foreground'>3 Depots, 5 Points de Vente</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className='flex flex-row items-center justify-between pb-2 space-y-0'>
      ...
      <Card>
        <CardHeader className='flex flex-row items-center justify-between pb-2 space-y-0'>
          <CardTitle className='text-sm font-medium'>Tournees Vrac</CardTitle>
          <Route className='w-4 h-4 text-muted-foreground' />
        </CardHeader>
        <CardContent>
          <div className='text-2xl font-bold'>4</div>
          <p className='text-xs text-muted-foreground'>En cours d'execution</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className='flex flex-row items-center justify-between pb-2 space-y-0'>
          <CardTitle className='text-sm font-medium'>Tournees 50 kg</CardTitle>
      ...
      <Card className='col-span-2 lg:col-span-4'>
        ...
        <CardContent className='flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-x-8 sm:gap-y-3'>
          <div className='flex items-center gap-2 min-w-0'>
            ...
            <span className='text-sm truncate'>Region: {marketer.region}</span>
          </div>
          <div className='flex items-center gap-2 min-w-0'>
