import { type SiteType, type SiteStatus } from '@/features/sites/sites'
 ...
 * des entrees avec le `marketerId` correspondant.
 */
export const marketerSites: MarketerSite[] = [
  ...
  { id: 'ms-total-02', marketerId: 'MKT-001', name: 'Total Nsam', type: 'marketer', city: 'Yaounde', region: 'Centre', status: 'active' },
  { id: 'ms-total-03', marketerId: 'MKT-001', name: 'Total Bonamoussadi', type: 'marketer', city: 'Douala', region: 'Littoral', status: 'active' },
  { id: 'ms-total-04', marketerId: 'MKT-001', name: 'Total Mokolo', type: 'marketer', city: 'Yaounde', region: 'Centre', status: 'active' },
  { id: 'ms-total-05', marketerId: 'MKT-001', name: 'Depot Total Bonaberi', type: 'depot', city: 'Douala', region: 'Littoral', status: 'active' },
  { id: 'ms-total-06', marketerId: 'MKT-001', name: 'Depot Total Nsam', type: 'depot', city: 'Yaounde', region: 'Centre', status: 'active' },
  ...
  { id: 'ms-tradex-02', marketerId: 'MKT-006', name: 'Tradex Biyem-Assi', type: 'marketer', city: 'Yaounde', region: 'Centre', status: 'active' },
  { id: 'ms-tradex-03', marketerId: 'MKT-006', name: 'Tradex Ndokoti', type: 'marketer', city: 'Douala', region: 'Littoral', status: 'active' },
  { id: 'ms-tradex-04', marketerId: 'MKT-006', name: 'Depot Tradex Bonaberi', type: 'depot', city: 'Douala', region: 'Littoral', status: 'active' },
  ...
  { id: 'ms-camgaz-02', marketerId: 'MKT-002', name: 'Camgaz Yaounde Mvan', type: 'marketer', city: 'Yaounde', region: 'Centre', status: 'active' },
  { id: 'ms-camgaz-03', marketerId: 'MKT-002', name: 'Depot Camgaz Bonaberi', type: 'depot', city: 'Douala', region: 'Littoral', status: 'active' },
  ...
  { id: 'ms-ola-02', marketerId: 'MKT-003', name: 'Ola Energy Ngousso', type: 'marketer', city: 'Yaounde', region: 'Centre', status: 'active' },
  { id: 'ms-ola-03', marketerId: 'MKT-003', name: 'Ola Energy Bafoussam', type: 'marketer', city: 'Bafoussam', region: 'Ouest', status: 'active' },
  { id: 'ms-ola-04', marketerId: 'MKT-003', name: 'Depot Ola Energy Douala', type: 'depot', city: 'Douala', region: 'Littoral', status: 'active' },
